...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        ...
        <a class="nav-link" href="#">Редактирование статей</a>
      </li>
      <li class="nav-item">
...
<div class="row">
 ...
 <div style="width:100%; margin-bottom:10px">
     <h5 style="float:left; display:inline-block; padding-top:3px">Статьи</h5><button class="btn btn-primary" style="float:right; display:inline-block;" data-toggle="modal" data-target="#add_prod">Добавить</button>
 </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Добавление статьи</h5>
    ...
    <label for="tovar_name">Название статьи</label>
